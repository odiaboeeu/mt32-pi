...
OBJS		:=	src/config.o \
			...
			src/synth/soundfontsynth_stub.o \
...
# Circle Step 51: allow Make to resolve bare header dependencies generated by dependency files
VPATH += $(CIRCLESTDLIBHOME)/include

INCLUDE		+=	-I$(CIRCLESTDLIBHOME)/include
...
# SC55-only: EXTRALIBS	+=	$(FLUIDSYNTHLIB)
...
# Circle Step 51: include paths for C++ compilation
CXXFLAGS        +=      -I"$(NEWLIBDIR)/include" \
                        -I$(STDDEF_INCPATH) \
                        -I$(CIRCLESTDLIBHOME)/include \
                        -Iinclude \
                        -I.
